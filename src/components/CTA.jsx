...
const CTA = () => {
  return (
    <section className='bg-gradient-to-bl from-[#163832] to-[#051F20] h-100'>
        <div className='max-w-screen-xl mx-auto px-6 md:px-10'>
             <div className="bg-[#DAF1DE] p-8 md:p-12 rounded-3xl flex items-center justify-center flex-col">
                ...
                <div className='flex flex-wrap items-center justify-center gap-4 md:gap-6'>
                  <button className='text-[#163832] text-base md:text-xl font-semibold px-6 py-3 rounded-full border-2 border-[#163832] hover:bg-[#163832] hover:text-[#DAF1DE] transition duration-300 ease-in-out'>
                    Join the Lab
                  </button>
                  <button className='text-[#163832] text-base md:text-xl font-semibold px-6 py-3 rounded-full border-2 border-[#163832] hover:bg-[#163832] hover:text-[#DAF1DE] transition duration-300 ease-in-out'>
                    View All Projects
